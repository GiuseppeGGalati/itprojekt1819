...
public class CellListTextbeitrag extends AbstractCell<Textbeitrag> {
	...
	@Override
	public void onBrowserEvent(com.google.gwt.cell.client.Cell.Context context, Element parent, Textbeitrag value,
			NativeEvent event, ValueUpdater<Textbeitrag> valueUpdater) {
		...
		if ("click".equals(event.getType())) {
			...
			if (parent.getFirstChildElement().isOrHasChild(Element.as(eventTarget))) {
				...
				sb.appendHtmlConstant(
						"<div contentEditable='false' unselectable='true'>" + value.getInhalt() + "</div>");
			}
		}
	}
	...
	public void render(com.google.gwt.cell.client.Cell.Context context, Textbeitrag value, SafeHtmlBuilder sb) {
		...
		sb.appendHtmlConstant("<p></p>");
		sb.appendHtmlConstant(
				"<div id = 'hallogiuse' contentEditable='true' unselectable='false'>" + value.getInhalt() + "</div>");
	}
